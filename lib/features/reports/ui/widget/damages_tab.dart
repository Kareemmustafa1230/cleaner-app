...
class DamagesTab extends StatefulWidget {
  ...
  const DamagesTab({
    ...
    required this.onDamagePriceChanged,
  });

  @override
  State<DamagesTab> createState() => _DamagesTabState();
}

class _DamagesTabState extends State<DamagesTab> {
          ...
          TextFormField(
            ...
            validator: (value) {
              if (value == null || value.isEmpty) {
                return context.translate(LangKeys.pleaseEnterDamagesDescription);
              }
              return null;
            },
          ),
        ...
        children: [
          ...
          TextFormField(
            ...
            onChanged: (value) {
              ...
              widget.onDamagePriceChanged(convertedValue);
            },
            validator: (value) {
              if (value == null || value.isEmpty) {
  ...
  InputDecoration _inputDecoration({required String hintText, required IconData prefixIcon, String? suffixText}) {
