...
class _AppTextFormFieldState extends State<TextFormFieldApp> {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      style: widget.inputTextStyle ?? TextStyleApp.font16greyC1Weight700,
      ...
      decoration: InputDecoration(
        ...
        fillColor: widget.background ?? ColorApp.black00,
        filled: true,
        isDense: true,
        contentPadding: widget.contentPadding ??
            EdgeInsets.symmetric(horizontal: 20.w, vertical: 17.h),
        hintStyle: widget.hintStyle ?? TextStyleApp.font16greyC1Weight700,
        ...
        suffixIcon: widget.showEye && widget.isPassword
          ...
          icon: Icon(
            ...
            color: widget.iconColor ?? ColorApp.greyC1,
          ),
          iconSize: 23,
        )
            : widget.suffixIcon,
        enabledBorder: widget.enableBorder ??
            OutlineInputBorder(
              ...
              borderSide: BorderSide(color: ColorApp.greyC1, width: 1.w),
            ),
